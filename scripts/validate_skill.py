...
if (ROOT/'VERSION').read_text().strip()!='1.2.6': errors.append('VERSION must be 1.2.6')
...
need('modules/commerce/stock-image-protocol.md','TEXT_FREEZE','IMAGE_PAYLOAD','一、最新行情','二、奇门十日节奏曲线（未来十个交易日）','三、关键价格区域（元）','四、未来十个交易日操作计划表','五、卦象定性判断','六、综合结论','禁止生成九宫格','程序化渲染','下载附件链接','禁止用生成式图片模型')
